...
public class HelloWorldTest {
    ...
    void register_NullLogin_ThrowsError() {
        ...
        RegistrationError expectedError = new RegistrationError(Errors.Login_NotNull);
        assertEquals(expectedError.getMessage(), registrationError.getMessage());
    }
    ...
    void register_NullPassword_ThrowsError() {
        ...
        user.setAge(29);
        RegistrationError registrationError = assertThrows(RegistrationError.class, () -> registrationUser.register(user));
        RegistrationError expectedError = new RegistrationError(Errors.Password_NotNull);
        assertEquals(expectedError.getMessage(),registrationError.getMessage());
    ...
    void register_NullAge_ThrowsError() {
        ...
        user.setAge(null);
        RegistrationError registrationError = assertThrows(RegistrationError.class, () -> registrationUser.register(user));
        RegistrationError expectedError = new RegistrationError(Errors.Age_NotNull);
        assertEquals(expectedError.getMessage(),registrationError.getMessage());
    }
    ...
    void register_ShortLogin_ThrowsError() {
        ...
        user.setAge(35);
        RegistrationError registrationError = assertThrows(RegistrationError.class, () -> registrationUser.register(user));
        RegistrationError expectedError = new RegistrationError(Errors.Short_UserLogin);
        assertEquals(expectedError.getMessage(),registrationError.getMessage());
    }
    ...
    void register_ShortPassword_ThrowsError() {
        ...
        user.setAge(25);
        RegistrationError registrationError = assertThrows(RegistrationError.class, () -> registrationUser.register(user));
        RegistrationError expectedError = new RegistrationError(Errors.Short_UserPassword);
        assertEquals(expectedError.getMessage(),registrationError.getMessage());
    }
    ...
    void register_YoungAge_ThrowsError() {
        ...
        user.setAge(17);
        assertThrows(RegistrationError.class, () -> registrationUser.register(user));
    }
    ...
    void register_DuplicateLogin_ThrowsError() {
        ...
        user.setAge(42);
        RegistrationError registrationError = assertThrows(RegistrationError.class, () -> registrationUser.register(user));
        RegistrationError expectedError = new RegistrationError(Errors.Login_inUse);
        assertEquals(expectedError.getMessage(),registrationError.getMessage());
    }
}
